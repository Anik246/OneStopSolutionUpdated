  ...
  return (
    <div className="containers">
      ...
      <div className='inner-container'>
        <div className='nav-main-container'>
          <nav className='nav-contents'>
            <ul className="nav-links">
              ...
              <li>
                <a href="#" onClick={toggleNews} className={showQuestions ? 'active' : ''}>Latest Questions</a>
              </li>
              <li>
        ...
        <div className='info'>
          {showEvents && (
            events.map((event, index) => (
              ...
              <Link className='link-events' to="/events">
        ...
        <div>
          {showEvents ? <button className='button'>View all events</button> : ""}
